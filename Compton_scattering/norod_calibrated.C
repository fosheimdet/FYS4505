...
double xmin = offset-gain/2;
double xmax = offset + gain/2 + gain*1024; //Why doe we offset it by gain/2?

TH1D* h_bgr = new TH1D("h_bgr", "h_bgr", 1024, xmin, xmax);

TH1D* h_zeroNR = new TH1D("h_guessed0", "", 1024, xmin, xmax);
TH1D* h_35NR = new TH1D("h_35NR", "", 1024, xmin, xmax);
TH1D* h_65NR = new TH1D("h_65NR", "", 1024, xmin, xmax);
TH1D* h_95NR = new TH1D("h_95NR", "", 1024, xmin, xmax);
TH1D* h_120NR = new TH1D("h_120NR", "", 1024, xmin, xmax);
...
AddText( 0.9, 0.045, "Energy[KeV]" ,0.04,0.,"right");
AddText( 0.12, 0.93, "dN/dE" ,0.04,0.,"right");
