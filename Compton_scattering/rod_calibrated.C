...
double x,y; //Variables to store the columns of the input file streams
...
int rebinFactor = 1;
h_guessed0->SetLineColor(kRed-2);
...
h_guessed0->SetAxisRange(0,750); //For easier fitting, we restrict the x-axis
...
TLegend* leg = new TLegend(0.15,0.5,0.35,0.85);
...
// gStyle->SetOptFit();
//
// TF1* f0 = new TF1("f0", "gausn(0)", 640,690);
// f0->SetParameters(3000, 662, 20);
//
// h_guessed0->Fit(f0, "PMER+");
// f0->Draw("same");
